            ...
            <div className="px-4 py-3 space-y-4">
              ...
              <div className="space-y-2">
                ...
                {!debugAnalysis ? (
                  ...
                  <div className="w-full bg-black/30 rounded-md p-4 text-[13px] leading-[1.4] text-gray-100 max-h-[600px] overflow-y-auto">
                    <MarkdownRenderer>{debugAnalysis}</MarkdownRenderer>
                  </div>
                )}
              </div>
