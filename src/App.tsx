    ...
    <QueryClientProvider client={queryClient}>
      <ToastProvider>
        <ToastContext.Provider value={{ showToast }}>
          <div className="h-screen w-screen flex flex-col bg-zinc-950/90 text-zinc-100 backdrop-blur-xl border border-zinc-800/60 rounded-xl overflow-hidden font-sans antialiased">
            {isInitialized ? (
              hasApiKey ? (
                <Suspense fallback={
