...
export function Header({ currentLanguage, setLanguage, onOpenSettings }: HeaderProps) {
  ...
  return (
    <div className="bg-black pt-2 px-3 pb-1 border-b border-white/10 flex items-center justify-between">
      <div className="flex items-center space-x-1">
        <span className="text-white text-sm mr-2">Language:</span>
        <div className="relative">
          <button
            onClick={toggleDropdown}
            className="flex items-center gap-1.5 rounded-md bg-white/5 px-2.5 py-1 text-xs text-white hover:bg-white/10 transition-colors"
          >
      ...
      <div className="flex items-center space-x-2">
        <Button
          variant="ghost"
          size="sm"
          className="h-7 px-2 text-white/70 hover:text-white hover:bg-white/10 flex items-center gap-1.5"
        ...
        <Button
          variant="ghost"
          size="sm"
          className="h-7 px-2 text-red-400/80 hover:text-red-400 hover:bg-white/10 flex items-center gap-1.5"
